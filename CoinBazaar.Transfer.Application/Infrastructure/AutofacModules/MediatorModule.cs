...
namespace CoinBazaar.Transfer.Application.Infrastructure.AutofacModules
{
    public class MediatorModule : Autofac.Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterAssemblyTypes(typeof(CreateTransferCommand).GetTypeInfo().Assembly)
            ...
            builder
                .RegisterAssemblyTypes(typeof(CreateTransferCommandValidator).GetTypeInfo().Assembly)
